      ...
      return noStoreJson(
        {
          ...
          message: "Enter a support question between 3 and 500 characters.",
        },
        400,
      );
    }
    ...
    return noStoreJson(
      {
        ...
        message:
          "Support assistance is temporarily unavailable. Normal DIREKT product flows remain available.",
      },
      503,
    );
  }
