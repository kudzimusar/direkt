WITH app_schemas(schema_name) AS (
  VALUES
    ('platform'), ('account'), ('authz'), ('provider'), ('catalog'),
    ('evidence'), ('verification'), ('discovery'), ('provider_workspace'),
    ('operations'), ('interaction'), ('commercial'), ('security')
)
SELECT json_build_object(
  ...
  'private_bucket_count', (
    ...
    WHERE id IN (
      'provider-evidence', 'provider-media-private',
      'provider-media-public', 'system-exports'
    ) AND public = false
  ),
