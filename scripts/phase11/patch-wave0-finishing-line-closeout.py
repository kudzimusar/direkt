...
replace(lock, "The repository write lane is CLAIMED for Phase 11C–11J execution readiness only. RC0–RC11 evidence remains immutable/regression-protected. Real participants, real participant data, real money and production authorization remain blocked until the explicit Phase 11 entry checklist is satisfied.", "The repository write lane is RELEASED. RC0–RC11, Phase 11C–11J readiness and Wave 0 finishing-line evidence remain immutable/regression-protected. Real participants, participant data, real money and production authorization remain blocked until the explicit Phase 11 entry checklist is satisfied.")
...
replace(verifier, '    "P11-G14 closed for that exact source only",', f'    "P11-G14 is closed for that exact repository source only",')
