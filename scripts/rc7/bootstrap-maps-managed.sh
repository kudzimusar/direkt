...
printf 'project=%s\n' "${PROJECT_ID}"
printf 'region=%s\n' "${REGION}"
printf 'backend_authentication=service_identity_oauth\n'
printf 'backend_oauth_scope=https://www.googleapis.com/auth/maps-platform.geocode.address\n'
printf 'backend_api_key_created=false\n'
printf 'backend_secret_value_created=false\n'
printf 'backend_cloud_nat_created=false\n'
printf 'android_key_authority=temporary_api_keys_admin\n'
printf 'runtime_service_usage_authority=temporary\n'
