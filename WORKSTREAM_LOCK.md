...
| Implementation branch | `integration/uia-owner-review-promotion-current` from `main@8c08168faa8205c06401a4bff06f017a39d34536`. |
| Stable baseline | RC5 source PR #377 merged at `7e718ce0a1a5d5e58b04566e7f14c8fbc5ddc463` with exact-head regressions green; current `main@8c08168faa8205c06401a4bff06f017a39d34536` additionally contains the reviewed Next.js 16.2.11 security update from PR #380. RC5 remains `IMPLEMENTED_GATED / MANAGED MATRIX PENDING` at an owner-controlled Google Cloud bootstrap boundary; draft PR #378 is preserved and must remain unmerged while UIA owns exact-current-main promotion. RC4 remains closed with managed FCM proof run `29916381754` successful. |
