...
describe('visibleNavigation', () => {
  it('shows reviewer work but not finance or administration', () => {
    ...
    expect(labels).toEqual(['Mission control', 'Verification queue']);
  });

  it('keeps finance out of verification controls', () => {
    const labels = visibleNavigation(
